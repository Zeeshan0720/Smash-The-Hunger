...
if (isset($_SESSION['user_email'])) { 
    ...
    $sql = "SELECT * FROM active_donations WHERE email = '$email'"; 
...
<?php include 'donor_navbar.html'; ?>
    ...
    <div class="box1">
      <div class="box2">
        <h1 >My Donations</h1>
        <div id="displaytble" style="margin-left: -300px;">
   <table >
        <thead>
            <tr>
                <!-- <th >Email</th>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a style='background-color: #CE7C02;border-style:none;' href='donor_details.php?id=" . $row['d_id'] . "' class='btn btn-primary'>Details</a></td>";
            echo "</tr>";
        }
    } else {
