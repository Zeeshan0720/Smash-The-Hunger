...
<body>
    ...
    <div class="box1">
        <div class="box2">
            <h1 style="text-align: center; margin-top: 20x; position: relative; bottom: 40px; font-size: 40px;">Receiver Registration</h1>
            ...
            <div style=" margin-top: -30px;"><a href="donor_reg.php" style="text-decoration: none; margin-left: 160px;">Click here for Donor Registration</a>
            </div>
        </div>
    </div>
